...
import AddDetailAdder from "./AddDetailAdder.js";
import DetailAdderInfo from "./DetailAdderInfo.js";
import RecipientDashboard from "../../main_dashboard/views/Dashboard/Dashboard.js";
...
import ViewDetailAdders from "./ViewDetailAdders.js";
...
export default function Recipient({ ...rest }) {
  const switchRoutes = (
    <Switch>
      {routes.map((prop, key) => {
        if (prop.layout === "/recipient") {
          return (
            <Route
      ...
      <Route
        exact
        path="/recipient/view-detail/:id"
        component={DetailAdderInfo}
      />
      <Route
        exact
        path="/recipient/view-transaction/:id"recipient
        component={ViewTransactions}
      />
      <Route exact path="/recipient/view-request/:id" component={ViewRequests} />
      <Redirect from="/recipient" to="/recipient/dashboard" />
    </Switch>
  );
  ...
  const getRoute = () => {
    return window.location.pathname !== "/recipient/maps";
  };
