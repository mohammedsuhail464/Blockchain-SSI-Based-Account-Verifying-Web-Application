...
import ViewReceivedVerify from "./ViewReceivedVerify";
import BankerReceiveUnique from "./ReceiveUnique";
import RequestUniqueBanker from "./RequestUnique";
import CarryVerify from "./CarryVerify";
import ViewResponses from "../Events/ViewResponses.js";
import BankerVerifyInfo from "./BankerVerifyInfo";

import ViewRequests from "../Events/ViewRequests.js";
import ViewTransactions from "../Transactions/ViewTransactions.js";

import BankerDashboard from "../../main_dashboard/views/Dashboard/Dashboard.js";
...
const routes = [
  {
    path: "/view-verify",
    name: "View Received Verify",
    icon: ViewItem,
    component: ViewReceivedVerify,
    layout: "/banker",
  },
  {
...
export default function Banker({ ...rest }) {
  const switchRoutes = (
    <Switch>
      {routes.map((prop, key) => {
      ...
      <Route
        exact
        path="/banker/view-verify/:id"
        component={BankerVerifyInfo}
      />
      <Route
        exact
        path="/banker/view-request/:id"
        component={ViewRequests}
      />
      <Route
        exact
        path="/banker/view-transaction/:id"
        component={ViewTransactions}
      />
      <Redirect from="/banker" to="/banker/dashboard" />
    </Switch>
  );
  ...
  const getRoute = () => {
    return window.location.pathname !== "/banker/maps";
  };
