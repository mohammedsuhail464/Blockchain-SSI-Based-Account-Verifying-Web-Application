...
export default function BankerReceiveUnique(props) {
  ...
  async function handleSubmit() {
    ...
    let verificationOutput = await verifySignature(sender, signature);
    if(verificationOutput) {
      alert('Signature verified');
      verificationChain.methods.bankerReceivedVerify(address, sender, signature).send({from: account})
