...
export default function BankerVerifyInfo(props) {
  ...
  async function getVerifyCOata() {
    ...
    let subcontractAddress = await verificationChain.methods
    ...
    let display = (
      <div>
        ...
        <p>
          ...
          <Link
            to={{
              pathname: `/banker/view-transaction/${data[7]}`,
    ...
    return (
      <div>
        ...
        <Button variant="contained" color="primary">
          <Link
            to={{
              pathname: `/banker/view-request/${verifyAddress}`,
              query: {
